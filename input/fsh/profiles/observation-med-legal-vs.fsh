Profile: ObservacionMedLegalVS
Parent: ObservacionCL
Id: ObservacionMedLegalVS
Title: "Observación Medico Legal Violencia Sexual"
Description: "Observación que registra la fecha y hora de la realización del informe de violencia sexual"
* status 1..1 MS
...
* valueDateTime ^short = "Fecha y hora realización de informe de violencia sexual"
Profile: ConditionDiagnostico
Parent: DiagnosticoCl
Id: ConditionDiagnosticoLE
Title: "Condition Diagnostico"
Description: "Condicion Diagnostico, recurso que se utiliza para indicar el diagnóstico tanto de ingreso como egreso de un paciente en un servicio de urgencias"
...
* code 1..1 MS
  ...
  * text 0..1 MS
  * text ^short = "Descripcion en texto libre correspondiente al diagnóstico realizado por el médico"
* code ^short = "Código correspondiente al diagnóstico realizado por el médico"
...
* recorder 1..1 MS
* recorder only Reference(PrestadorProfesional)
* recorder ^short = "Profesional que registra la condición"
